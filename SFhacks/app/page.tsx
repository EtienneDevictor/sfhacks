    ...
    <main className="flex flex-row h-full">
      <div className="w-1/4 h-full">
        ...
        <div className="flex flex-col" style={{ transform: 'translateX(50%)' }}>
          <Link href="/NewStory">
            <span className="hidden md:flex flex-row items-center text-black text-3xl mb-8">
      ...
      <div className="relative h-full w-3/4 flex justify-center items-center" style={{ 
        ...
        <h1 className="text-4xl font-bold text-white" style={{ transform: 'translateY(150px)' }}>:: Your Story :: </h1>
      </div>
    </main>
  );
}
